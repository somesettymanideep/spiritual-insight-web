...
export default function PoojaDetail() {
  ...
  const service = POOJA_SERVICES.find((s) => s.slug === slug);

  useEffect(() => {
    if (service) setMeta(`${service.title} — Pooja & Prayer`, service.desc);
  }, [service]);
  ...
  return (
    <SiteLayout>
      ...
      <main className="bg-background py-20">
        <div className="site-container grid max-w-6xl items-start gap-12 lg:grid-cols-2">
          ...
          <article>
            ...
            <div className="rounded-2xl bg-gradient-primary p-7 text-primary-foreground shadow-elegant">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 font-bold text-white transition-transform hover:scale-105">
