...
export function Footer() {
  return (
    <footer className="relative bg-cosmos text-cosmos-foreground overflow-hidden">
      ...
      <div className="relative site-container py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <img src={asset("logo.png")} alt={SITE.name} className="h-14 bg-white/95 rounded-lg p-1 mb-4" />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li><Link to="/pooja-prayer" className="hover:text-gold">Pooja & Prayer</Link></li>
