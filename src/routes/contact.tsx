  ...
  return (
    <SiteLayout>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6 md:px-8 lg:px-10 grid lg:grid-cols-3 gap-6 mb-16">
          {[
        ...
        <div className="container mx-auto px-6 md:px-8 lg:px-10 grid lg:grid-cols-2 gap-10 items-start">
          <div>
