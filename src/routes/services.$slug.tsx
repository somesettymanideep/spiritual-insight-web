  ...
  if (!service) {
    return (
      <SiteLayout>
        ...
        <section className="py-20 container mx-auto px-4 md:px-6 lg:px-8 text-center">
  ...
  return (
    <SiteLayout>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 grid lg:grid-cols-[1fr_320px] gap-10 items-start">
          <article>
